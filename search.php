...
$sql = "SELECT * FROM `library` 
        ...
        OR `author_first_name` LIKE '%$searchQuery%' 
        OR `author_last_name` LIKE '%$searchQuery%' 
        OR CONCAT(`author_first_name`, ' ', `author_last_name`) LIKE '%$searchQuery%'";
    ...
    foreach ($rows as $key => $value) {
        $layout .=  "<div><div class='card' style='width: 18rem;'>
                        ...
                        <div class='card-body'>
                            ...
                            <a href='publisher.php?publisher_name={$value["publisher_name"]}'>{$value["publisher_name"]}</a>
    ...
    <nav class="navbar bg-body-secondary">
        <div class="container-fluid">
            ...
            <form class="d-flex" role="search" action="search.php" method="GET">
                <input class="form-control me-2" type="search" name="query" placeholder="Search" aria-label="Search" value="<?= htmlspecialchars($searchQuery) ?>">
